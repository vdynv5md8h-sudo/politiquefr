...
export { synchroniserAmendements } from './amendements-an.service';
export { synchroniserQuestions } from './questions-an.service';
...
export { calculerStatistiquesDeputes, getStatistiquesMoyennesAssemblee } from './deputes-stats.service';
export { synchroniserSeancesPubliques } from './seances-an.service';
export { synchroniserCommissions, synchroniserMembresCommissions } from './commissions-an.service';
